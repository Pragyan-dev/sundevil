...
export function ChatWindow() {
  ...
  return (
    <div className="paper-card flex min-h-[44rem] flex-col overflow-hidden p-0">
      ...
      <div className="flex flex-wrap gap-2 border-b border-[rgba(140,29,64,0.08)] px-6 py-4">
      ...
      <div className="flex-1 space-y-4 overflow-y-auto px-6 py-6">
        {messages.map((message) => (
          ...
          >
            <div
              className={`max-w-[85%] rounded-[1.6rem] px-5 py-4 text-sm leading-7 shadow-[0_16px_38px_rgba(85,53,47,0.08)] ${
                message.role === "user"
      ...
      <form
        className="border-t border-[rgba(140,29,64,0.08)] bg-[rgba(255,255,255,0.7)] px-6 py-5"
        onSubmit={(event) => {
      ...
      >
        ...
        <div className="flex flex-col gap-3 md:flex-row">
          <textarea
            ...
            rows={3}
            className="field-shell min-h-28 flex-1 resize-none"
          />
          <button type="submit" disabled={isSending} className="button-primary min-w-40 self-start">
